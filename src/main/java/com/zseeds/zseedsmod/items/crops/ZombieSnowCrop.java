...
public class ZombieSnowCrop extends ZombieBaseCrop {

	public ZombieSnowCrop(String name) {
		super(name);
	}
	...
	public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
		...
		if(this.getAge(state) == 4) {
			...
			ResourceLocation name = new ResourceLocation("zseeds:snow_zombie");
	...
	{
		return ModItems.ZombieSnowSeeds;
	}
}