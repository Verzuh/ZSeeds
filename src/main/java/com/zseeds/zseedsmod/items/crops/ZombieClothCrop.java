...
public class ZombieClothCrop extends ZombieBaseCrop {

	public ZombieClothCrop(String name) {
		super(name);
	}
	...
	public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
		...
		if(this.getAge(state) == 4) {
			...
			ResourceLocation name = new ResourceLocation("zseeds:cloth_zombie");
	...
	{
		return ModItems.ZombieClothSeeds;
	}
}