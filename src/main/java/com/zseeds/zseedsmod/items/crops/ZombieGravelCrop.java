...
public class ZombieGravelCrop extends ZombieBaseCrop {

	public ZombieGravelCrop(String name) {
		super(name);
	}
	...
	public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
		...
		if(this.getAge(state) == 4) {
			...
			ResourceLocation name = new ResourceLocation("zseeds:gravel_zombie");
	...
	{
		return ModItems.ZombieGravelSeeds;
	}
}