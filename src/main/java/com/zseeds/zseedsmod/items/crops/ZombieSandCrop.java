...
public class ZombieSandCrop extends ZombieBaseCrop {

	public ZombieSandCrop(String name) {
		super(name);
	}
	...
	public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
		...
		if(this.getAge(state) == 4) {
			...
			ResourceLocation name = new ResourceLocation("zseeds:sand_zombie");
	...
	{
		return ModItems.ZombieSandSeeds;
	}
}