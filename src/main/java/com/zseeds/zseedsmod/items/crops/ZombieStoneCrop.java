...
public class ZombieStoneCrop extends ZombieBaseCrop {

	public ZombieStoneCrop(String name) {
		super(name);
	}
	...
	public void randomTick(World worldIn, BlockPos pos, IBlockState state, Random random) {
		...
		if(this.getAge(state) == 4) {
			...
			ResourceLocation name = new ResourceLocation("zseeds:stone_zombie");
	...
	{
		return ModItems.ZombieStoneSeeds;
	}
}