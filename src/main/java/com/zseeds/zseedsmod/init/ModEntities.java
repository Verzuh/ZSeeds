...
public class ModEntities {
    ...
    public static void init() {
        ...
        EntityRegistry.registerModEntity(new ResourceLocation(Reference.MODID, "coal_zombie"), ZombieCoal.class, "CoalZombie", id++, ZSeeds.instance, 64, 3, true, 0x996600, 0x00ff00);
        ...
        LootTableList.register(ZombieCoal.LOOT);
    }
    ...
    public static void initModels() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ZombieCoal.class, RenderZombieCoal.FACTORY);
    }
}