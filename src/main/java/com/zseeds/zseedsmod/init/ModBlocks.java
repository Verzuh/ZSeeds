...
public class ModBlocks {
	...
	public static void init() {
		...
		exampleCrop = new ZombieCrop("example_crop");
	}
	
	@SubscribeEvent
	public static void registerBlocks(RegistryEvent.Register<Block> event) {
		event.getRegistry().registerAll(exampleBlock, exampleCrop);
	}
	
	@SubscribeEvent
	public static void registerItemBlocks(RegistryEvent.Register<Item> event) {
		event.getRegistry().registerAll(new ItemBlock(exampleBlock).setRegistryName(exampleBlock.getRegistryName()));
		ModItems.exampleSeeds = new ZombieSeeds(ModBlocks.exampleCrop, Blocks.DIRT, "example_seeds").setCreativeTab(ModItems.tabExampleMod);
		event.getRegistry().register(ModItems.exampleSeeds);
	}
